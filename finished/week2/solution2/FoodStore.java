...
public class FoodStore {
    ...
    public int getAmountDeposited() {	// added method
	return(amountDeposited);
    }
    public int getAmountWithdrawn() {	// added method
	return(amountWithdrawn);
    }
    public int getNumDeposits() {	// added method
	return(numDeposits);
    }
    public int getNumWithdrawals() {	// added method
    ...
    private int numDeposits;		// added
    private int numWithdrawals;		// added
